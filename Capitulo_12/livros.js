...
router.post("/", async (req, res) => {
    ...
    if (!titulo || !autor || !ano || !preco || !foto) {
        res.status(400).json({
            msg: "Enviar titulo, autor, ano, preco e foto do livro",
        });
        return;
    }
...
// Método delete é usando para exclusão
...
router.get("/dados/grafico", async (req, res) => {
    try { 
        // Obtém o ano e soma do preco dos livros (com o nome total), agrupados por ano
